...
?>
<h3> ::การจัดการประเภทคำถาม ป.มสด.1:: 
  <a href="question1.php?p=add" class="btn btn-primary btn-sm">+เพิ่ม</a></h3>
<table border="1" cellpadding="0" cellspacing="0" class="table table-hover table-bordered">
  ...
  <?php $i=1; do { ?>
    <tr>
      ...
      <td>
         <a href="question1.php?qt_id=<?php echo $row_listquestion1['qt_id']; ?>&p=add_q" class="btn btn-info btn-xs" target=_blank>+คำถาม</a>
      </td>
      <td>
