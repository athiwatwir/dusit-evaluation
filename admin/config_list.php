...
<div class="row">
    <div class="col-md-12">
        <h3 class="text-primary prompt-400"><i class="fa fa-bookmark" aria-hidden="true"></i> การจัดการ รอบการประเมิน</h3>
    </div>
    <div class="col-md-12 form-group">
         <a href="config.php?p=add" class="btn btn-primary btn-sm">+เพิ่ม</a>
    </div>
</div>
